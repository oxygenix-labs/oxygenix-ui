...
export function DataTable<T = any>(props: DataTableProps<T>) {
  ...
  const someSelected = paginatedData.some((row, index) => selectedRows.has(getRowKey(row, index)));
      ...
      <table className={styles['data-table']}>
        <thead className={styles['data-table-header']}>
          <tr>
            {selectable && (
              <th
                className={cn(styles['data-table-header-cell'], styles['data-table-checkbox-cell'])}
              >
                <Checkbox
                  checked={allSelected}
            ...
            return (
              ...
              >
                {selectable && (
                  <td
                    className={cn(
                      styles['data-table-body-cell'],
                      styles['data-table-checkbox-cell']
                    )}
                  >
                    <Checkbox
                      checked={isSelected}
